...
*    *                              The value will be an informative error message that will be displayed to the user.
     */
    void registerDefiner(String teamName, String playerName, Consumer<FullGameDetails> onRegistrationSuccess, Consumer<String> onRegistrationFailure);
     ...
     *    *                              The value will be an informative error message that will be displayed to the user.
     */
    void registerGuesser(String teamName, String playerName, Consumer<FullGameDetails> onRegistrationSuccess, Consumer<String> onRegistrationFailure);
}
